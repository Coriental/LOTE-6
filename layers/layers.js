...
//ol.proj.get("EPSG:32721").setExtent([444361.008305, 7188279.747058, 461393.741566, 7197291.977766]);
var wms_layers = [];
...
var format_09052025_8 = new ol.format.GeoJSON();
var features_09052025_8 = format_09052025_8.readFeatures(json_09052025_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_09052025_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_09052025_8.addFeatures(features_09052025_8);
var lyr_09052025_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_09052025_8, 
                style: style_09052025_8,
                popuplayertitle: '09-05-2025',
                interactive: true,
                title: '<img src="styles/legend/09052025_8.png" /> 09-05-2025'
            });
var format_MTSubterraneo3x1x240_L6_9 = new ol.format.GeoJSON();
var features_MTSubterraneo3x1x240_L6_9 = format_MTSubterraneo3x1x240_L6_9.readFeatures(json_MTSubterraneo3x1x240_L6_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_MTSubterraneo3x1x240_L6_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MTSubterraneo3x1x240_L6_9.addFeatures(features_MTSubterraneo3x1x240_L6_9);
var lyr_MTSubterraneo3x1x240_L6_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MTSubterraneo3x1x240_L6_9, 
                style: style_MTSubterraneo3x1x240_L6_9,
                popuplayertitle: 'MT Subterraneo 3x1x240_L6',
                interactive: true,
                title: '<img src="styles/legend/MTSubterraneo3x1x240_L6_9.png" /> MT Subterraneo 3x1x240_L6'
            });
...
var group_Baslica = new ol.layer.Group({
                                ...
                                title: 'Basílica'});
var group_LOTE6 = new ol.layer.Group({
                                layers: [lyr_postexist_4,lyr_Postacin19112024_5,lyr_PostacionL6Nuevo29042025_6,lyr_PostacionSistL6Exist29042025_7,lyr_09052025_8,],
                                fold: 'close',
                                title: 'LOTE 6'});
var group_Lote2 = new ol.layer.Group({
                                layers: [],
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_PDL60411_2.setVisible(true);lyr_PDL6Sist29042025_3.setVisible(true);lyr_postexist_4.setVisible(true);lyr_Postacin19112024_5.setVisible(true);lyr_PostacionL6Nuevo29042025_6.setVisible(true);lyr_PostacionSistL6Exist29042025_7.setVisible(true);lyr_09052025_8.setVisible(true);lyr_MTSubterraneo3x1x240_L6_9.setVisible(true);lyr_BT3x701x501x25_10.setVisible(true);lyr_MT3x35_11.setVisible(true);lyr_MT3x70_12.setVisible(true);lyr_MT3x185_L6_13.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_OpenStreetMap_1,group_Lote6,group_LOTE6,lyr_MTSubterraneo3x1x240_L6_9,lyr_BT3x701x501x25_10,lyr_MT3x35_11,lyr_MT3x70_12,lyr_MT3x185_L6_13];
...
lyr_09052025_8.set('fieldAliases', {'Alimentado': 'Alimentado', 'Numero de': 'Numero de', 'Tipo de Po': 'Tipo de Po', 'N�mero d': 'N�mero d', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
lyr_MTSubterraneo3x1x240_L6_9.set('fieldAliases', {'Fecha': 'Fecha', 'Inicio-Fin': 'Inicio-Fin', 'Alimentado': 'Alimentado', 'Longitud': 'Longitud', 'Item': 'Item', 'DO/ACO': 'DO/ACO', });
lyr_BT3x701x501x25_10.set('fieldAliases', {'FECHA': 'FECHA', 'INICIO-FIN': 'INICIO-FIN', 'LONGITUD': 'LONGITUD', 'ÍTEM': 'ÍTEM', 'ALIMEN': 'ALIMEN', 'DO/ACO': 'DO/ACO', 'Inicio-F_1': 'Inicio-F_1', });
...
lyr_09052025_8.set('fieldImages', {'Alimentado': 'TextEdit', 'Numero de': 'TextEdit', 'Tipo de Po': 'TextEdit', 'N�mero d': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
lyr_MTSubterraneo3x1x240_L6_9.set('fieldImages', {'Fecha': 'TextEdit', 'Inicio-Fin': 'TextEdit', 'Alimentado': 'TextEdit', 'Longitud': 'TextEdit', 'Item': 'TextEdit', 'DO/ACO': 'TextEdit', });
lyr_BT3x701x501x25_10.set('fieldImages', {'FECHA': 'TextEdit', 'INICIO-FIN': 'TextEdit', 'LONGITUD': 'TextEdit', 'ÍTEM': 'TextEdit', 'ALIMEN': 'TextEdit', 'DO/ACO': 'TextEdit', 'Inicio-F_1': '', });
...
lyr_09052025_8.set('fieldLabels', {'Alimentado': 'no label', 'Numero de': 'no label', 'Tipo de Po': 'no label', 'N�mero d': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_MTSubterraneo3x1x240_L6_9.set('fieldLabels', {'Fecha': 'no label', 'Inicio-Fin': 'no label', 'Alimentado': 'no label', 'Longitud': 'no label', 'Item': 'no label', 'DO/ACO': 'no label', });
lyr_BT3x701x501x25_10.set('fieldLabels', {'FECHA': 'inline label - visible with data', 'INICIO-FIN': 'inline label - visible with data', 'LONGITUD': 'inline label - visible with data', 'ÍTEM': 'inline label - visible with data', 'ALIMEN': 'inline label - visible with data', 'DO/ACO': 'inline label - visible with data', 'Inicio-F_1': 'no label', });
