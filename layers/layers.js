...
var format_postacionL61009_2 = new ol.format.GeoJSON();
var features_postacionL61009_2 = format_postacionL61009_2.readFeatures(json_postacionL61009_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_postacionL61009_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_postacionL61009_2.addFeatures(features_postacionL61009_2);
var lyr_postacionL61009_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_postacionL61009_2, 
                style: style_postacionL61009_2,
                popuplayertitle: "postacion L6 10-09",
                interactive: true,
                title: '<img src="styles/legend/postacionL61009_2.png" /> postacion L6 10-09'
            });
...
var group_LOTE6 = new ol.layer.Group({
                                layers: [lyr_postexist_1,lyr_postacionL61009_2,],
                                fold: "open",
                                title: "LOTE 6"});
var group_Lote6 = new ol.layer.Group({
                                layers: [lyr_PD5_3,],
...
lyr_OpenStreetMap_0.setVisible(true);lyr_postexist_1.setVisible(true);lyr_postacionL61009_2.setVisible(true);lyr_PD5_3.setVisible(true);lyr_MT3x185_L6_4.setVisible(true);lyr_MT3x70_5.setVisible(true);lyr_MT3x35_6.setVisible(true);lyr_BT3x701x501x25_7.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,group_LOTE6,group_Lote6,lyr_MT3x185_L6_4,lyr_MT3x70_5,lyr_MT3x35_6,lyr_BT3x701x501x25_7];
lyr_postexist_1.set('fieldAliases', {'Nro Sosten': 'Nro Sosten', 'poste': 'poste', 'x': 'x', 'y': 'y', 'XX': 'XX', 'yy': 'yy', });
lyr_postacionL61009_2.set('fieldAliases', {'ALIMENT.': 'ALIMENT.', 'Sostén': 'Sostén', 'TIPO/POSTE': 'TIPO/POSTE', 'Coord.X': 'Coord.X', 'Coord. Y': 'Coord. Y', 'Nro de Fá': 'Nro de Fá', });
...
lyr_MT3x185_L6_4.set('fieldAliases', {'FECHA': 'FECHA', 'INICIO-FIN': 'INICIO-FIN', 'LONGITUD': 'LONGITUD', });
lyr_MT3x70_5.set('fieldAliases', {'FECHA': 'FECHA', 'INICIO-FIN': 'INICIO-FIN', 'LONGITUD': 'LONGITUD', });
lyr_MT3x35_6.set('fieldAliases', {'FECHA': 'FECHA', 'INICIO-FIN': 'INICIO-FIN', 'LONGITUD': 'LONGITUD', });
lyr_BT3x701x501x25_7.set('fieldAliases', {'FECHA': 'FECHA', 'INICIO-FIN': 'INICIO-FIN', 'LONGITUD': 'LONGITUD', });
lyr_postexist_1.set('fieldImages', {'Nro Sosten': 'TextEdit', 'poste': 'TextEdit', 'x': 'TextEdit', 'y': 'TextEdit', 'XX': 'TextEdit', 'yy': 'TextEdit', });
lyr_postacionL61009_2.set('fieldImages', {'ALIMENT.': 'TextEdit', 'Sostén': 'TextEdit', 'TIPO/POSTE': 'TextEdit', 'Coord.X': 'TextEdit', 'Coord. Y': 'TextEdit', 'Nro de Fá': 'TextEdit', });
...
lyr_MT3x185_L6_4.set('fieldImages', {'FECHA': 'TextEdit', 'INICIO-FIN': 'TextEdit', 'LONGITUD': 'TextEdit', });
lyr_MT3x70_5.set('fieldImages', {'FECHA': 'TextEdit', 'INICIO-FIN': 'TextEdit', 'LONGITUD': 'TextEdit', });
lyr_MT3x35_6.set('fieldImages', {'FECHA': 'TextEdit', 'INICIO-FIN': 'TextEdit', 'LONGITUD': 'TextEdit', });
lyr_BT3x701x501x25_7.set('fieldImages', {'FECHA': 'TextEdit', 'INICIO-FIN': 'TextEdit', 'LONGITUD': 'TextEdit', });
lyr_postexist_1.set('fieldLabels', {'Nro Sosten': 'no label', 'poste': 'no label', 'x': 'no label', 'y': 'no label', 'XX': 'no label', 'yy': 'no label', });
lyr_postacionL61009_2.set('fieldLabels', {'ALIMENT.': 'no label', 'Sostén': 'no label', 'TIPO/POSTE': 'no label', 'Coord.X': 'no label', 'Coord. Y': 'no label', 'Nro de Fá': 'no label', });
lyr_PD5_3.set('fieldLabels', {'Nro de Sosten': 'inline label - always visible', 'Alimentador': 'inline label - always visible', 'x': 'no label', 'y': 'no label', 'Nro. De Fábrica': 'no label', 'Nro. de Ande': 'no label', 'Cuadrilla': 'no label', });
lyr_MT3x185_L6_4.set('fieldLabels', {'FECHA': 'no label', 'INICIO-FIN': 'no label', 'LONGITUD': 'no label', });
lyr_MT3x70_5.set('fieldLabels', {'FECHA': 'no label', 'INICIO-FIN': 'no label', 'LONGITUD': 'no label', });
lyr_MT3x35_6.set('fieldLabels', {'FECHA': 'no label', 'INICIO-FIN': 'no label', 'LONGITUD': 'no label', });
lyr_BT3x701x501x25_7.set('fieldLabels', {'FECHA': 'no label', 'INICIO-FIN': 'no label', 'LONGITUD': 'no label', });
