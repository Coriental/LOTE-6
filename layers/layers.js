...
//ol.proj.get("EPSG:32721").setExtent([447681.320732, 7192067.176828, 448934.475076, 7192730.236354]);
var wms_layers = [];
...
var format_PDL6Sist04032025_3 = new ol.format.GeoJSON();
var features_PDL6Sist04032025_3 = format_PDL6Sist04032025_3.readFeatures(json_PDL6Sist04032025_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDL6Sist04032025_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDL6Sist04032025_3.addFeatures(features_PDL6Sist04032025_3);
var lyr_PDL6Sist04032025_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDL6Sist04032025_3, 
                style: style_PDL6Sist04032025_3,
                popuplayertitle: "PD L6 Sist 04-03-2025",
                interactive: true,
                title: '<img src="styles/legend/PDL6Sist04032025_3.png" /> PD L6 Sist 04-03-2025'
            });
...
var format_PostacionL6Nuevo01042025_6 = new ol.format.GeoJSON();
var features_PostacionL6Nuevo01042025_6 = format_PostacionL6Nuevo01042025_6.readFeatures(json_PostacionL6Nuevo01042025_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL6Nuevo01042025_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL6Nuevo01042025_6.addFeatures(features_PostacionL6Nuevo01042025_6);
var lyr_PostacionL6Nuevo01042025_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL6Nuevo01042025_6, 
                style: style_PostacionL6Nuevo01042025_6,
                popuplayertitle: "Postacion L6 Nuevo 01-04-2025",
                interactive: true,
                title: '<img src="styles/legend/PostacionL6Nuevo01042025_6.png" /> Postacion L6 Nuevo 01-04-2025'
            });
var format_PostacionL6SistExis01042025_7 = new ol.format.GeoJSON();
var features_PostacionL6SistExis01042025_7 = format_PostacionL6SistExis01042025_7.readFeatures(json_PostacionL6SistExis01042025_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL6SistExis01042025_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL6SistExis01042025_7.addFeatures(features_PostacionL6SistExis01042025_7);
var lyr_PostacionL6SistExis01042025_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL6SistExis01042025_7, 
                style: style_PostacionL6SistExis01042025_7,
                popuplayertitle: "Postacion L6 Sist Exis 01-04-2025",
                interactive: true,
                title: '<img src="styles/legend/PostacionL6SistExis01042025_7.png" /> Postacion L6 Sist Exis 01-04-2025'
            });
...
var group_Lote6 = new ol.layer.Group({
                                layers: [lyr_PDL60411_2,lyr_PDL6Sist04032025_3,],
                                fold: "open",
                                title: "Lote 6"});
...
var group_Baslica = new ol.layer.Group({
                                ...
                                title: "Basílica"});
var group_LOTE6 = new ol.layer.Group({
                                layers: [lyr_postexist_4,lyr_Postacin19112024_5,lyr_PostacionL6Nuevo01042025_6,lyr_PostacionL6SistExis01042025_7,],
                                fold: "open",
                                title: "LOTE 6"});
var group_Lote2 = new ol.layer.Group({
                                layers: [],
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_PDL60411_2.setVisible(true);lyr_PDL6Sist04032025_3.setVisible(true);lyr_postexist_4.setVisible(true);lyr_Postacin19112024_5.setVisible(true);lyr_PostacionL6Nuevo01042025_6.setVisible(true);lyr_PostacionL6SistExis01042025_7.setVisible(true);lyr_MTSubterraneo3x1x240_L6_8.setVisible(true);lyr_BT3x701x501x25_9.setVisible(true);lyr_MT3x35_10.setVisible(true);lyr_MT3x70_11.setVisible(true);lyr_MT3x185_L6_12.setVisible(true);
...
lyr_PDL6Sist04032025_3.set('fieldAliases', {'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 6': 'Alimentadores Lote 6', 'Marca del transformador': 'Marca del transformador', 'DENOMINACI�N': 'DENOMINACI�N', 'N�ANDE': 'N�ANDE', 'Latitud': 'Latitud', 'Longitud': 'Longitud', });
...
lyr_PostacionL6Nuevo01042025_6.set('fieldAliases', {'Alimentadores Lote 6': 'Alimentadores Lote 6', 'Numero de Sosten': 'Numero de Sosten', 'Tipo de Poste': 'Tipo de Poste', 'N�mero de F�brica del Poste': 'N�mero de F�brica del Poste', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
lyr_PostacionL6SistExis01042025_7.set('fieldAliases', {'Alimentadores Lote 6': 'Alimentadores Lote 6', 'Numero de Sosten': 'Numero de Sosten', 'Tipo de Poste': 'Tipo de Poste', 'N�mero de F�brica del Poste': 'N�mero de F�brica del Poste', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PDL6Sist04032025_3.set('fieldImages', {'Numero de Sosten': 'TextEdit', 'Alimentadores Lote 6': 'TextEdit', 'Marca del transformador': 'TextEdit', 'DENOMINACI�N': 'TextEdit', 'N�ANDE': 'Range', 'Latitud': 'TextEdit', 'Longitud': 'TextEdit', });
...
lyr_PostacionL6Nuevo01042025_6.set('fieldImages', {'Alimentadores Lote 6': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'N�mero de F�brica del Poste': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
lyr_PostacionL6SistExis01042025_7.set('fieldImages', {'Alimentadores Lote 6': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'N�mero de F�brica del Poste': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
...
lyr_PDL6Sist04032025_3.set('fieldLabels', {'Numero de Sosten': 'no label', 'Alimentadores Lote 6': 'no label', 'Marca del transformador': 'no label', 'DENOMINACI�N': 'no label', 'N�ANDE': 'no label', 'Latitud': 'no label', 'Longitud': 'no label', });
...
lyr_PostacionL6Nuevo01042025_6.set('fieldLabels', {'Alimentadores Lote 6': 'no label', 'Numero de Sosten': 'no label', 'Tipo de Poste': 'no label', 'N�mero de F�brica del Poste': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_PostacionL6SistExis01042025_7.set('fieldLabels', {'Alimentadores Lote 6': 'no label', 'Numero de Sosten': 'no label', 'Tipo de Poste': 'no label', 'N�mero de F�brica del Poste': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
