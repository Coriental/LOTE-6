...
//ol.proj.get("EPSG:32721").setExtent([446129.706956, 7188460.051429, 461167.559079, 7196416.765752]);
var wms_layers = [];
...
var format_PostacionSistL6Exist03072025_4 = new ol.format.GeoJSON();
var features_PostacionSistL6Exist03072025_4 = format_PostacionSistL6Exist03072025_4.readFeatures(json_PostacionSistL6Exist03072025_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionSistL6Exist03072025_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionSistL6Exist03072025_4.addFeatures(features_PostacionSistL6Exist03072025_4);
var lyr_PostacionSistL6Exist03072025_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionSistL6Exist03072025_4, 
                style: style_PostacionSistL6Exist03072025_4,
                popuplayertitle: 'Postacion Sist L6 Exist 03-07-2025',
                interactive: true,
                title: '<img src="styles/legend/PostacionSistL6Exist03072025_4.png" /> Postacion Sist L6 Exist 03-07-2025'
            });
var format_PostacionSistL6Nuevo03072025_5 = new ol.format.GeoJSON();
var features_PostacionSistL6Nuevo03072025_5 = format_PostacionSistL6Nuevo03072025_5.readFeatures(json_PostacionSistL6Nuevo03072025_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionSistL6Nuevo03072025_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionSistL6Nuevo03072025_5.addFeatures(features_PostacionSistL6Nuevo03072025_5);
var lyr_PostacionSistL6Nuevo03072025_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionSistL6Nuevo03072025_5, 
                style: style_PostacionSistL6Nuevo03072025_5,
                popuplayertitle: 'Postacion Sist L6 Nuevo 03-07-2025',
                interactive: true,
                title: '<img src="styles/legend/PostacionSistL6Nuevo03072025_5.png" /> Postacion Sist L6 Nuevo 03-07-2025'
            });
...
var format_PDL6Sist03072025_12 = new ol.format.GeoJSON();
var features_PDL6Sist03072025_12 = format_PDL6Sist03072025_12.readFeatures(json_PDL6Sist03072025_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDL6Sist03072025_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDL6Sist03072025_12.addFeatures(features_PDL6Sist03072025_12);
var lyr_PDL6Sist03072025_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDL6Sist03072025_12, 
                style: style_PDL6Sist03072025_12,
                popuplayertitle: 'PD L6 Sist 03-07-2025',
                interactive: true,
                title: '<img src="styles/legend/PDL6Sist03072025_12.png" /> PD L6 Sist 03-07-2025'
            });
...
var group_Lote6 = new ol.layer.Group({
                                layers: [lyr_PDL60411_11,lyr_PDL6Sist03072025_12,],
                                fold: 'close',
                                title: 'Lote 6'});
...
var group_Baslica = new ol.layer.Group({
                                ...
                                title: 'Basílica'});
var group_LOTE6 = new ol.layer.Group({
                                layers: [lyr_postexist_2,lyr_Postacin19112024_3,lyr_PostacionSistL6Exist03072025_4,lyr_PostacionSistL6Nuevo03072025_5,],
                                fold: 'close',
                                title: 'LOTE 6'});
var group_Lote2 = new ol.layer.Group({
                                layers: [],
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_postexist_2.setVisible(true);lyr_Postacin19112024_3.setVisible(true);lyr_PostacionSistL6Exist03072025_4.setVisible(true);lyr_PostacionSistL6Nuevo03072025_5.setVisible(true);lyr_MTSubterraneo3x1x240_L6_6.setVisible(true);lyr_BT3x701x501x25_7.setVisible(true);lyr_MT3x35_8.setVisible(true);lyr_MT3x70_9.setVisible(true);lyr_MT3x185_L6_10.setVisible(true);lyr_PDL60411_11.setVisible(true);lyr_PDL6Sist03072025_12.setVisible(true);
...
lyr_PostacionSistL6Exist03072025_4.set('fieldAliases', {'Alimentadores Lote 6': 'Alimentadores Lote 6', 'Numero de Sosten': 'Numero de Sosten', 'Tipo de Poste': 'Tipo de Poste', 'N�mero de F�brica del Poste': 'N�mero de F�brica del Poste', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
lyr_PostacionSistL6Nuevo03072025_5.set('fieldAliases', {'Alimentadores Lote 6': 'Alimentadores Lote 6', 'Numero de Sosten': 'Numero de Sosten', 'Tipo de Poste': 'Tipo de Poste', 'N�mero de F�brica del Poste': 'N�mero de F�brica del Poste', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PDL6Sist03072025_12.set('fieldAliases', {'Tipo de Poste': 'Tipo de Poste', 'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 6': 'Alimentadores Lote 6', 'Nro de Fabrica del trafo': 'Nro de Fabrica del trafo', 'N�ANDE': 'N�ANDE', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PostacionSistL6Exist03072025_4.set('fieldImages', {'Alimentadores Lote 6': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'N�mero de F�brica del Poste': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
lyr_PostacionSistL6Nuevo03072025_5.set('fieldImages', {'Alimentadores Lote 6': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'N�mero de F�brica del Poste': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
...
lyr_PDL6Sist03072025_12.set('fieldImages', {'Tipo de Poste': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Alimentadores Lote 6': 'TextEdit', 'Nro de Fabrica del trafo': 'Range', 'N�ANDE': 'Range', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
...
lyr_PostacionSistL6Exist03072025_4.set('fieldLabels', {'Alimentadores Lote 6': 'no label', 'Numero de Sosten': 'no label', 'Tipo de Poste': 'no label', 'N�mero de F�brica del Poste': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_PostacionSistL6Nuevo03072025_5.set('fieldLabels', {'Alimentadores Lote 6': 'no label', 'Numero de Sosten': 'no label', 'Tipo de Poste': 'no label', 'N�mero de F�brica del Poste': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
...
lyr_PDL6Sist03072025_12.set('fieldLabels', {'Tipo de Poste': 'no label', 'Numero de Sosten': 'no label', 'Alimentadores Lote 6': 'no label', 'Nro de Fabrica del trafo': 'no label', 'N�ANDE': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_PDL6Sist03072025_12.on('precompose', function(evt) {
