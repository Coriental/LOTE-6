...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 3, projection: new ol.proj.Projection({
            code: 'EPSG:32721',
            //extent: [-20037508.342789, -20037508.342789, 20037508.342789, 71899991.000000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([444264.483499, 7188208.770767, 462304.518131, 7197753.977142], map.getSize());
